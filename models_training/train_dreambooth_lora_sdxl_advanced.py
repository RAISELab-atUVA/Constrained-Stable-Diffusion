...
def save_model_card(
    ...
    for i, image in enumerate(images):
        image = image.float().cpu().detach().numpy() #SZ
        image += 1  #SZ
        image = (np.round(image * 255/2)).astype(np.uint8) #SZ
        image = np.transpose(image, (1, 2, 0)) #SZ
        image = Image.fromarray(image) #SZ
            ...
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                with autocast_ctx:
                    ...
                    images = [
                        ...
                        pipeline(**pipeline_args, generator=generator)[0] ### SZ ###
    ...
    if accelerator.is_main_process:
        ...
        if args.validation_prompt and args.num_validation_images > 0:
            ...
            images = [
                ...
                pipeline(args.validation_prompt, num_inference_steps=25, generator=generator)[0]
                for _ in range(args.num_validation_images)
            ]
